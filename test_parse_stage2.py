...
# data_mean = 58.08913621726867
# data_std = 71.16849465558357
...
def test_single_volume(image, label, net, classes, multimask_output, patch_size=[512, 512], test_save_path=None, case=None):
    ...
    probability = repeat(probability, 'd h w c -> d h w (repeat c)', repeat=classes+1) #TODO +1 
    ...
    for ind in range(image.shape[0]):
        ...
        with torch.no_grad():
            ...
            # print(probability[ind: ind+5].shape)
...
def config_to_dict(config):
    ...
    return items_dict
#/home/ET/bnwu/MA-SAM/data/synapseCT/Training/2D_all_5slice
#/home/ET/bnwu/MA-SAM/data/AIIB23_Train_T1/2D_all_5slice
if __name__ == '__main__':
    ...
    parser.add_argument('--module', type=str, default='sam_fact_tt_image_encoder_hq')
